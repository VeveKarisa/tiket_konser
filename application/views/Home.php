<div>
    ...
    <div class="w-full h-screen">
        <div>
            <h1 class="p-10 font-bold text-xl">Top Selling Concert Ticket</h1>
            <div class="grid grid-cols-4 gap-4 p-10">
                <div class="flex gap-3">
                    <h1>1</h1>
                    <img src="<?= base_url('assets/img/s.png') ?>" alt="">
                    <p class="text-sm font-bold w-28">SHEILA ON7: TUNGGU AKU DI BANDUNG</p>
                </div>
                <div class="flex gap-3">
                    <h1>1</h1>
                    <img src="<?= base_url('assets/img/s.png') ?>" alt="">
